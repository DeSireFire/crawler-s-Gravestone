...
async def rec():
    ...
    cookies = {
        ...
        'Hm_lpvt_c35e3a563a06caee2524902c81975add': '1682329406',
        'access_token': 'bearer%20eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFkbWluIiwidXNlcl9pZCI6MSwiZXhwIjoxNjgyNTg0ODMyfQ.hWfj_BmZ-6Qmo-8QlQLt4SPkVYCSCl1RysD2Y_raCKI',
    }

    headers = {
        'Accept': 'application/json, text/plain, */*',
        'Accept-Language': 'zh-CN,zh-TW;q=0.9,zh;q=0.8,en;q=0.7,und;q=0.6,ja;q=0.5',
        'Authorization': 'bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFkbWluIiwidXNlcl9pZCI6MSwiZXhwIjoxNjgyNTg0ODMyfQ.hWfj_BmZ-6Qmo-8QlQLt4SPkVYCSCl1RysD2Y_raCKI',
        'Cache-Control': 'no-cache',
        'Connection': 'keep-alive',
        'Content-Type': 'application/json',
        # 'Cookie': 'order=id%20desc; serverType=nginx; pro_end=-1; ltd_end=-1; memSize=3931; bt_user_info=%7B%22status%22%3Atrue%2C%22msg%22%3A%22%u83B7%u53D6%u6210%u529F%21%22%2C%22data%22%3A%7B%22username%22%3A%22139****5360%22%7D%7D; sites_path=/www/wwwroot; site_model=php; cna=9dbada9446e64fa1b6f2090d2e4d7f61; 90f7209532efbcd84ed663aa163caf82=c1c3fff3-33b9-4824-8263-21b816815b45.mX0lNmarVxbII0leFX9GSkYcUSs; request_token=9fdJwkKivxBuTRi9zy7laSNB0B7pwpvCxMlQPiKLRddBWGZM; backup_path=/www/backup; grafana_session=dc44db4a4a6bb890ac89d8e52e5f2b7a; Hm_lvt_c35e3a563a06caee2524902c81975add=1681093596,1682056131; sidebar_status=closed; Hm_lpvt_c35e3a563a06caee2524902c81975add=1682329406; access_token=bearer%20eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFkbWluIiwidXNlcl9pZCI6MSwiZXhwIjoxNjgyNTg0ODMyfQ.hWfj_BmZ-6Qmo-8QlQLt4SPkVYCSCl1RysD2Y_raCKI',
        'Origin': 'http://api.cox.ink:8001',
        'Pragma': 'no-cache',
        'Referer': 'http://api.cox.ink:8001/',
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36',
        'X-Access-Token': 'bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFkbWluIiwidXNlcl9pZCI6MSwiZXhwIjoxNjgyNTg0ODMyfQ.hWfj_BmZ-6Qmo-8QlQLt4SPkVYCSCl1RysD2Y_raCKI',
    }

    json_data = {
        'start_timestamp': 1681893636,
        'end_timestamp': 1682498436,
        'measurement': '测试项目',
